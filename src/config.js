...
export const config={
  ...
  tempDir:resolve(process.env.TEMP_DIR||'./storage/temp'),
  ...
  maxArchiveFiles:positiveInteger(process.env.MAX_ARCHIVE_FILES,500),
  maxExtractedBytes:positiveInteger(process.env.MAX_EXTRACTED_BYTES,2*1024*1024*1024),
